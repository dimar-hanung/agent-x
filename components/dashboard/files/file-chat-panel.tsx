...
export function FileChatPanel({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
      {!indexReady ? (
        <div
          className="shrink-0 rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-sm"
          role="status"
        >
          {indexStatus === "failed" ? (
            ...
            <div className="space-y-2">
              ...
              {progressPercent !== null ? (
                ...
                <p className="text-muted-foreground text-xs">
                  Anda bisa melihat pratinjau di kanan; kirim pertanyaan setelah
                  indeks selesai.
                </p>
              )}
            </div>
