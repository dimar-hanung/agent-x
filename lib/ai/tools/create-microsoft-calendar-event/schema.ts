...
export const createMicrosoftCalendarEventInputSchema = z.object({
...
export type CreateMicrosoftCalendarEventInput = z.infer<
  typeof createMicrosoftCalendarEventInputSchema
>;
