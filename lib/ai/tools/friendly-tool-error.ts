...
const TOOL_FRIENDLY_NOUNS = {
  ...
  send_microsoft_email: "email Outlook",
  search_microsoft_inbox: "inbox Outlook",
  read_microsoft_email: "email Outlook",
  list_microsoft_calendar_events: "kalender Microsoft",
  create_microsoft_calendar_event: "kalender Microsoft",
  search_onedrive: "OneDrive",
  read_onedrive_file: "OneDrive",
  upload_onedrive_file: "OneDrive",
  list_todos: "todo",
  get_todo: "todo",
  create_todo: "todo",
  update_todo: "todo",
  ...
  ask_file: "penyimpanan file",
  list_whatsapp_chats: "WhatsApp",
  list_whatsapp_contacts: "kontak WhatsApp",
  list_whatsapp_groups: "grup WhatsApp",
