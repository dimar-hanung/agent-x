...
export const listMicrosoftCalendarEventsInputSchema = z.object({
  time_min: z
    .string()
    .optional()
    .describe(
...
export type ListMicrosoftCalendarEventsInput = z.infer<
  typeof listMicrosoftCalendarEventsInputSchema
>;
