...
export const uploadOnedriveFileInputSchema = z
  .object({
    name: z
      .string()
      .min(1)
    ...
    parent_folder_id: z
      .string()
      .optional()
      .describe("Optional OneDrive folder id to upload into."),
  })
...
export type UploadOnedriveFileInput = z.infer<
  typeof uploadOnedriveFileInputSchema
>;
